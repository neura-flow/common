...
func TestCall(t *testing.T) {
	...
	completion := types.NewTongYiCompletionRequest("qwen-long")
...
func TestCallQWen_Max(t *testing.T) {
	client := New(&Config{
		ServerUrl: "https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions",
		Secret:    "xxx",
	})

	completion := types.NewTongYiCompletionRequest("qwen-plus")
	completion.ResponseFormat = &types.ResponseFormat{
		Type: "json_object",
	}
	completion.Messages = []any{
		types.SystemMessage{
